...
namespace Unitycoding.UIWidgets{
	...
	public class UIWidgetInspector: Editor
	{
		...
		protected virtual void OnEnable()
		{
			...
			this.m_PropertyPathToDrawForBaseClasses=new string[] {this.m_Script.propertyPath, this.m_Name.propertyPath,this.m_Focus.propertyPath, this.m_EaseType.propertyPath, this.m_Duration.propertyPath, this.m_ShowSound.propertyPath, this.m_CloseSound.propertyPath };
